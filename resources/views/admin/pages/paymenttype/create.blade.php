...
@section('title')
Payment Type Management - Create
@endsection
@section('mainContent')
...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2><i class="fa fa-window-maximize" aria-hidden="true"></i> Add Payment Type</h2>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">
				<span class="label label-success float-right title-color">Add Payment Type Form</span>
			</li>
		</ol>
	</div>
</div>
